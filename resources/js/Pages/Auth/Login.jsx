...
import { LogIn, ShieldAlert, XCircle, Mail, Lock } from 'lucide-react';
          ...
          <article className="glass-panel fade-in-up-delay p-6 sm:p-8 border-t-4 border-t-amber-400">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                Masuk untuk melanjutkan belanja dan kelola produk.
              </p>
            </div>
  ...
  return (
    <form className="space-y-5" onSubmit={submit}>
      ...
      <div className="space-y-4">
        <div className="group">
          <label className="block text-sm font-bold text-white-600 mb-1 ml-1 group-focus-within:text-teal-600 transition-colors">
            Email
          </label>
      ...
      <div className="flex items-center justify-between px-1">
        ...
        <a
          href="#"
          className="text-xs font-bold text-teal-700 hover:text-teal-800 transition-colors dark:text-teal-300 dark:hover:text-teal-200"
        >
          Lupa sandi?
        </a>
      </div>
      ...
      <div className="mt-6 text-center border-t border-slate-100 pt-6">
        <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3 dark:text-slate-400">
          Belum punya akun?
        </p>
        <Link
          href={route('register')}
