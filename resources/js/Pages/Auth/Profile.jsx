  ...
  return (
    <LayoutApp pageTitle="Pengaturan Profil">
      ...
      <div className="w-full">
        <section
          className={`glass-panel fade-in-up p-6 sm:p-8 border-t-4 ${auth.user.role === 'seller' ? 'border-t-emerald-400' : 'border-t-indigo-400'}`}
        >
          <div className="mb-8">
            <h2 className="text-2xl font-black text-slate-900 dark:text-slate-100">
              Informasi Pribadi & Keamanan
            </h2>
            <p className="text-sm text-slate-500 font-medium mt-1 dark:text-slate-400  ">
              Kelola data diri, alamat, dan kata sandi Anda dalam satu tempat.
            </p>
          </div>
          ...
          {status === 'profile-updated' && (
            <div className="mb-6 flex items-center gap-3 rounded-2xl bg-teal-100 p-4 text-teal-700 border border-teal-150 animate-in fade-in zoom-in duration-300">
              ...
              <p className="text-sm font-bold dark:text-teal-700">
                Profil dan pengaturan berhasil diperbarui!
              </p>
            </div>
          )}
          ...
          <form onSubmit={submit} className="space-y-8">
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row sm:justify-start bg-slate-50/50 p-4 rounded-3xl border border-slate-100 dark:border-slate-800 dark:bg-slate-950/50">
              ...
              <div className="text-center sm:text-left">
                ...
                {errors.image && (
                  <p className="text-red-500 text-[10px] font-bold mt-1 uppercase dark:text-red-400 ">
                    {errors.image}
                  </p>
                )}
              </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-black uppercase tracking-widest text-slate-400 dark:text-slate-200">
                  Data Identitas
                </h3>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border-slate-200 bg-white p-2.5 pl-10 text-sm text-slate-900 placeholder:text-slate-400 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:placeholder:text-slate-500"
                    />
                  </div>
                  {errors.name && (
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className="w-full rounded-2xl border-slate-200 bg-white p-2.5 pl-10 text-sm text-slate-900 placeholder:text-slate-400 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:placeholder:text-slate-500"
                      placeholder="Jl. Raya Siliwangi No. 10..."
                    ></textarea>
                  </div>
                  {errors.address && (
                    <p className="text-red-500 text-[10px] font-bold ml-1">
