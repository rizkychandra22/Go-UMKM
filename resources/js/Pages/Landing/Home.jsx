                            ...
                            {heroList.map((item) => (
                                ...
                                >
                                        <Link 
                                            ...
                                            className="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-emerald-600 transition"
                                        >
                                            {item.name}
                                        </Link>                                   
                                        <span className={`ml-2 mr-2 inline-flex items-center rounded-full px-2 py-1 text-xs font-semibold ${item.badge === 'Populer' ? 'bg-amber-100 text-amber-700 dark:bg-amber-950/60 dark:text-amber-300' : item.badge === 'Terlaris' ? 'bg-teal-100 text-teal-700 dark:bg-teal-950/60 dark:text-teal-300' : 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300'}`}>{item.badge}</span>
