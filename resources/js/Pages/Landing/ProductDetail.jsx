            ...
            <Card className="pt-1 rounded-3xl border-slate-200 shadow-sm dark:border-slate-800 flex-1">
              <CardContent className="p-6 md:p-8">
                ...
                <div className="mt-8 flex items-center gap-3 rounded-2xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/40">
                  ...
                  <Link
                    href="#"
                    className="px-4 py-2 text-xs font-bold text-teal-600 border border-teal-200 rounded-lg hover:bg-teal-50 transition-colors dark:border-teal-800 dark:text-teal-400 dark:hover:bg-teal-900/30"
                  >
                    Kunjungi Toko
                  </Link>
                </div>
            ...
            <Card className="rounded-3xl border-slate-200 shadow-sm dark:border-slate-800">
              <CardContent className="p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center rounded-xl border border-slate-200 p-1 dark:border-slate-700 bg-slate-50 dark:bg-slate-950/50">
                      <Button
                        ...
                        className="size-8 font-bold text-slate-500 hover:text-orange-500 rounded-lg transition"
                      >
                        -
                      </Button>
                      ...
                      <Button
                        ...
                        className="size-8 font-bold text-slate-500 hover:text-teal-500 rounded-lg transition"
                      >
                        +
                      </Button>
                    </div>
                  ...
                  <Button
                    type="button"
                    className="flex flex-1 sm:flex-none items-center justify-center gap-2 rounded-xl bg-teal-600 px-8 py-6 text-sm font-bold text-white shadow-md shadow-teal-600/20 transition hover:bg-teal-700 hover:shadow-none"
                  >
                ...
                <div className="mt-5 flex items-center justify-center gap-6 text-xs font-semibold text-slate-500 dark:text-slate-400">
                  <span className="flex items-center gap-1.5">
                    <ShieldCheck className="size-4 text-teal-500" /> 100% Produk
                    Original
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Truck className="size-4 text-orange-500" /> Pengiriman
                    Cepat
                  </span>
                </div>
              </CardContent>
