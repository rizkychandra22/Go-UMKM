                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <div className="flex items-center gap-4">
                                    <Link href={route('home')} className="inline-flex size-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-600 shadow-sm transition-all hover:bg-slate-50 shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs font-medium text-slate-500 mt-0.5">Produk unggulan yang paling banyak diminati.</p>
                                    </div>
                                </div>

                                {/* --- Switch Button Tanpa Icon & Warna Amber --- */}
                                <div className="inline-flex items-center rounded-xl bg-slate-100 p-1 border border-slate-200 shadow-inner w-full sm:w-auto">
                                    <button
