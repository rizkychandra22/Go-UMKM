...
export default function Populer() {
    ...
    const popularProducts = products.filter(product => product.badge === 'Populer');

    return (
        <>
            {/* Mengatur Title di Browser Tab */}
            <Head title="Go-UMKM | Produk Populer" />

            {/* Dibungkus dengan LayoutApp agar Navigasi Atas & Footer otomatis muncul */}
            <LayoutApp pageTitle="Produk Populer">
