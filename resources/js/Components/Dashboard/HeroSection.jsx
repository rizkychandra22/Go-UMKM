        ...
        <div className="grid items-center gap-4 md:grid-cols-[1.4fr_0.6fr]">
          <div>
            ...
            <p className="mt-3 text-base leading-7 text-slate-600 dark:text-slate-400">
              Kelola produk dan stok Anda dengan mudah melalui platform digital
              kami.
            </p>
          </div>
          <div className="rounded-2xl border border-teal-100 bg-gradient-to-br from-teal-50 to-orange-50 p-5 dark:bg-gradient-to-br dark:from-teal-900/10 dark:to-orange-900/10">
            ...
            <p className="mt-1 text-3xl font-black text-teal-700 dark:text-slate-100">
              Rp 4.250.000
            </p>
            <p className="mt-2 flex items-center gap-2 text-xs font-medium text-slate-600 dark:text-slate-400">
              <BellRing className="size-4 text-orange-500 dark:text-orange-400" />{' '}
              5 Pesanan baru belum diproses
            </p>
          </div>
        </div>
      ) : (
        <div className="grid items-center gap-4 md:grid-cols-[1.4fr_0.6fr] ">
          <div>
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">
              Dukung ekonomi lokal dengan satu klik. Pantau status pesanan dan
              temukan kurasi produk terbaik minggu ini.
            </p>
          </div>

          <div className="rounded-2xl border border-teal-100 bg-gradient-to-br from-teal-50 to-orange-50 p-4 dark:bg-gradient-to-br dark:from-teal-900/10 dark:to-orange-900/10">
            <p className="text-xs font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400">
              Notifikasi
            </p>
            <p className="mt-2 inline-flex items-center gap-2 text-sm font-semibold text-slate-700 dark:text-slate-300">
              <BellRing className="size-4 text-orange-500 dark:text-orange-400 dark:bg-orange-900/10" />
